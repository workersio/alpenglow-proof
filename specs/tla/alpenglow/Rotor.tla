...
CONSTANTS
    ...
    RotorFanout,             \* Max relays contacted in a single dissemination step
    RotorMinRelayStake,      \* Minimum total stake covered by chosen relays
...
\* Candidate relay sets (nondeterministic universe)
